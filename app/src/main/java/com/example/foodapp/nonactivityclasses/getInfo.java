...
public class getInfo {
    ...
    static class Task implements Callable<String[]>{
        ...
        public String[] call() throws Exception{
            ...
            //set the url to http://23.16.93.156:10018/FoodAppLogin/getinfo.php if accessing from a location outside of alis localhost
            //it might already be set as the ip above, if so just leave it alone

            PutData putData = new PutData("http://23.16.93.156:10018/FoodAppLogin/getinfo.php", "POST", field, data);
            if (putData.startPut()) {
