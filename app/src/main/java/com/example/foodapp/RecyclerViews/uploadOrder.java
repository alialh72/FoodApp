    ...
    public void mUploadOrder(){
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                //set the url to http://23.16.93.156:10013//FoodAppLogin/uploadorder.php if accessing from a location outside of alis localhost
                //it might already be set as the ip above, if so just leave it alone
                PutData putData = new PutData("http://192.168.1.78:10019//FoodAppLogin/orderupload.php", "POST", field, data);
                if (putData.startPut()) {
