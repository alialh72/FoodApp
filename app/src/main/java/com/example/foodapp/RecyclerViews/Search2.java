...
public class Search2 extends RecyclerView.Adapter<Search2.ViewHolder>{
    ...
    public Search2(ArrayList<String> lrestauranttext,ArrayList<String> lrestaurantimage , Context context){
